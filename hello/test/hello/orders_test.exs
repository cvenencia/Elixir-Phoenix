defmodule Hello.OrdersTest do
  ...
  describe "orders" do
    ...
    @invalid_attrs %{total_price: nil, user_uuuuid: nil}
    ...
    test "create_order/1 with valid data creates a order" do
      valid_attrs = %{total_price: "120.5", user_uuuuid: "7488a646-e31f-11e4-aace-600308960662"}

      assert {:ok, %Order{} = order} = Orders.create_order(valid_attrs)
      assert order.total_price == Decimal.new("120.5")
      assert order.user_uuuuid == "7488a646-e31f-11e4-aace-600308960662"
    end
    ...
    test "update_order/2 with valid data updates the order" do
      order = order_fixture()
      update_attrs = %{total_price: "456.7", user_uuuuid: "7488a646-e31f-11e4-aace-600308960668"}

      assert {:ok, %Order{} = order} = Orders.update_order(order, update_attrs)
      assert order.total_price == Decimal.new("456.7")
      assert order.user_uuuuid == "7488a646-e31f-11e4-aace-600308960668"
    end
